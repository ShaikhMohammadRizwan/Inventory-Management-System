...
class ProductForm(forms.ModelForm):  # Change from forms.Form to forms.ModelForm
    class Meta:
        model = Product
        fields = '__all__'
        labels = {
        ...
        widgets = {
            ...
            'supplier': forms.TextInput(attrs={'placeholder': 'e.g. Dihan Group of Industry', 'class': 'form-control'}),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            'sku': forms.TextInput(attrs = {
                'placeholder': 'e.g S1234', 'class': 'form-control'
            }),
            'price': forms.NumberInput(attrs = {
                'placeholder': 'e.g. 99.99', 'class': 'form-control'
            }),
            'quantity': forms.NumberInput(attrs = {
                'placeholder': 'e.g. 10', 'class': 'form-control'
            }),
            'supplier': forms.TextInput(attrs = {
                'placeholder': 'e.g. Dihan Group of Industry', 'class': 'form-control'
            }),
        }